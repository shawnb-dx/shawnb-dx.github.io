document.addEventListener("DOMContentLoaded", function() {
    ...
    const moneyMethods = [{
            ...
            name: "Become A Twitch Affiliate",
            moneyPerSecond: 10,
            cost: 1000,
            purchased: false
        }, {
            name: "Sell Products At Farmers Market",
            moneyPerSecond: 20,
            cost: 2000,
            purchased: false
        }, {
            name: "Brew And Sell Own Beer",
            moneyPerSecond: 35,
            cost: 4000,
            purchased: false
        }, {
            name: "Give A Tour Guide",
            moneyPerSecond: 50,
            cost: 8000,
            purchased: false
        }, {
            name: "Become A Personal Trainer",
            moneyPerSecond: 75,
            cost: 16000,
            purchased: false
        }, {
            name: "Become A Twitch Partner",
            moneyPerSecond: 100,
            cost: 32000,
            purchased: false
        }, {
            name: "Take A Sponsorship Deal",
            moneyPerSecond: 150,
            cost: 64000,
            purchased: false
        }, {
            name: "Star In A Movie",
            moneyPerSecond: 200,
            cost: 128000,
            purchased: false
        },
    ...
    const studyMethods = [{
            name: "Read A Book",
            researchPointsPerSecond: 2,
            cost: 100,
            purchased: false
        }, {
            name: "Spend Time On Wikipedia",
            researchPointsPerSecond: 5,
            cost: 250,
            purchased: false
        }, {
            name: "Do A Mock Test",
            researchPointsPerSecond: 10,
            cost: 1000,
            purchased: false
        }, {
            name: "Experiment",
            researchPointsPerSecond: 20,
            cost: 2000,
            purchased: false
        }, {
            name: "Process Lab Work",
            researchPointsPerSecond: 35,
            cost: 4000,
            purchased: false
        }, {
            name: "Write A Research Paper",
            researchPointsPerSecond: 50,
            cost: 8000,
            purchased: false
        }, {
            name: "Give A TED Talk",
            researchPointsPerSecond: 75,
            cost: 16000,
            purchased: false
        }, {
            name: "Conduct A Field Study",
            researchPointsPerSecond: 100,
            cost: 32000,
            purchased: false
        }, {
            name: "Teach Some Students",
            researchPointsPerSecond: 150,
            cost: 64000,
            purchased: false
        }, {
            name: "Write A Best Selling Book",
            researchPointsPerSecond: 200,
            cost: 128000,
            purchased: false
        },
    ...
    const achievements = [
        // Money Achievements
        {
            name: "Starting Out Small",
            description: "Earn Your First $100.",
            unlocked: false
        }, {
            name: "A Ruff Road Ahead",
            description: "Earn Enough To Unlock Dog Walking",
            unlocked: false
        }, {
            name: "Starting A Livestream Empire",
            description: "Earn Enough To Start Streaming",
            unlocked: false
        }, {
            name: "Gift Of The Gab",
            description: "Earn Enough To Sell At Farmers Markets",
            unlocked: false
        }, {
            name: "Brewmaster",
            description: "Earn Enough To Make Your Own Beer",
            unlocked: false
        }, {
            name: "And On Your Left...",
            description: "Earn Enough To Become A Tour Guide",
            unlocked: false
        }, {
            name: "No Pain, No Gain",
            description: "Earn Enough To Become A Personal Trainer",
            unlocked: false
        }, {
            name: "Coming At You Live!",
            description: "Earn Enough To Make It Big On Twitch",
            unlocked: false
        }, {
            name: "Use My Affiliate Code",
            description: "Earn Enough To Get Your First Sponsorship",
            unlocked: false
        }, {
            name: "Name Up In Lights",
            description: "Earn Enough To Star In A Movie",
            unlocked: false
        },
        // Study Achievements
        {
            name: "Love A Good Book",
            description: "Gain 100 Research Points Reading Books",
            unlocked: false
        }, {
            name: "Wikipedia Knows All",
            description: "Gain Enough Knowledge In Order To Browse Wikipedia",
            unlocked: false
        }, {
            name: "Passing The Tests",
            description: "Gain Enough Knowledge In Order To Get Test Ready ",
            unlocked: false
        }, {
            name: "Experimentalist",
            description: "Gain Enough Knowledge In Order To Conduct Experiments ",
            unlocked: false
        }, {
            name: "Lab Prodigy",
            description: "Gain Enough Knowledge In Order To Become A Lab Technician ",
            unlocked: false
        }, {
            name: "Scholarly Author",
            description: "Gain Enough Knowledge In Order To Write Your Own Paper ",
            unlocked: false
        }, {
            name: "My Name Is TED",
            description: "Gain Enough Knowledge In Order To Become A TED Talker ",
            unlocked: false
        }, {
            name: "Out In The Fields Of Glory",
            description: "Gain Enough Knowledge In Order To Conduct Field Research",
            unlocked: false
        }, {
            name: "Shaping Young Minds",
            description: "Gain Enough Knowledge In Order To Teach A Class ",
            unlocked: false
        }, {
            name: "Bestselling Author",
            description: "Gain Enough Knowledge In Order To Become An Author",
            unlocked: false
        },
        // Level Up Achievements
        {
            ...
            name: "This Is Pretty Fun",
            description: "Reach Level 15",
            unlocked: false
        }, {
            name: "I Can't Stop Playing",
            ...
            name: "I'll Sleep Eventually",
            description: "Reach Level 500",
            unlocked: false
        }, {
            name: "You Won't Get This Achievement",
            description: "Reach Level 1000",
            unlocked: false
        }, {
            name: "Why Are You Still Here?!",
            description: "Reach Level 2500",
            unlocked: false
        }, {
            name: "The Game Doesn't Save Yet You Know...",
            description: "Reach Level 5000",
            unlocked: false
        }, {
            name: "Clearly You Have Too Much Time",
            description: "Reach Level 10000",
            unlocked: false
        },
    ...
    const perks = [{
        name: "Money Boost",
        description: "Increase money earnings by 10% (additive)",
        levels: [0.1, 0.21, 0.331, 0.4641, 0.61051, 0.771561, 0.9487171, 1.14358881, 1.357947691, 1.5937424601],
        cost: [1, 2, 3, 5, 8, 12, 15, 20, 25, 30, ],
        requiredLevel: [1, 3, 5, 10, 15, 25, 35, 50, 75, 100]
    }, ];
    ...
    function renderMoneyMethods() {
        ...
        moneyMethods.forEach((method, index) => {
            ...
            methodContainer.classList.add("money-method-container");

            const methodItem = document.createElement("div");
            methodItem.textContent = `${method.name} - Earns $${method.moneyPerSecond}/s - Cost: $${method.cost}`;
            methodItem.classList.add("money-method-item", "black-text"); // Add black-text class

            const methodButton = document.createElement("button");
            methodButton.textContent = method.purchased ? "Method Purchased" : "Start Earning";
            methodButton.classList.add("money-method-button");

            // Check if the method is available to purchase
            if (money >= method.cost && !method.purchased) {
                methodButton.classList.add("money-method-available");
                methodButton.addEventListener("click", () => {
                    startEarningMoney(index);
                });
            } else {
                methodButton.classList.add("money-method-unavailable");
                methodButton.disabled = true; // Disable the button if the method is not available
            }

            methodContainer.appendChild(methodItem);
            methodContainer.appendChild(methodButton);

            earnMoneyList.appendChild(methodContainer);
        });
    }
    ...
    function renderStudyMethods() {
        ...
        studyMethods.forEach((method, index) => {
            ...
            const methodItem = document.createElement("div");
            methodItem.textContent = `${method.name} - Earns $${method.researchPointsPerSecond}/s - Cost: $${method.cost}`;
            methodItem.classList.add("money-method-item", "black-text"); // Add black-text class
            ...
            // Check if the method is available to purchase
            if (money >= method.cost && !method.purchased) {
                methodButton.classList.add("study-method-available");
                methodButton.addEventListener("click", () => {
                    startStudying(index);
                });
            } else {
                methodButton.classList.add("study-method-unavailable");
                methodButton.disabled = true; // Disable the button if the method is not available
            }
            ...
            studyList.appendChild(methodContainer);
        });
        updateColors();
    }
    ...
    function renderAchievements() {
        ...
        achievements.forEach(achievement => {
            ...
            achievementsList.appendChild(achievementContainer);
        });
    }
